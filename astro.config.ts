...
export default defineConfig({
  ...
  experimental: {
    ...
    // The original theme uses the Fontshare provider (network fetch at dev/build time).
    // Keep this disabled by default and use local fonts under `public/fonts` instead.
    fonts: []
  }
})
